# Read Assembly ( 2025/12/10 )
## Description
アセンブリを読もう！

フラグは Alpaca{challenge関数の返り値} として送信してください。
## Solve
与えられるテキストファイルは以下の通りです。
```
0000000000000840 <challenge>:
 ...
 878:   d65f03c0        ret
```
これは、ARM64のアセンブラです。ARM64においては返り値がw0に格納されるため、w0を求めに行けばよさそうです。ただ読むだけなので、pythonスクリプトに書き換えて実行します。hexとintの使い分けに注意してください。
## Solver
``` python
w0 = 0
w1 = 0
